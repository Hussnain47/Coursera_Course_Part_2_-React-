...
class Contact extends Component {
  ...
  validate(firstname, lastname, telnum, email) {
    ...
    if (this.state.touched.firstname && firstname.length < 3) {
      errors.firstname = "First Name length should be >= 3";
    } else if (this.state.touched.firstname && firstname.length < 3) {
      errors.firstname = "First Name length should be <= 10";
    }
    if (this.state.touched.lastname && lastname.length < 3) {
      errors.lastname = "Last Name length should be >= 3";
    } else if (this.state.touched.lastname && lastname.length > 10) {
      errors.lastname = "Last Name length should be <= 10";
    }
